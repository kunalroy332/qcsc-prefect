...
molecules", J. Chem. Phys. 152, 074102 (2020). In particular the two-step
(alternating CI/orbital) scheme and the L-BFGS convergence acceleration of the
orbital optimization discussed therein.
